...
var Button = function (_a) {
    ...
    // handlers
    // common
    className = _a.className, css = _a.css, testId = _a.testId, children = _a.children;
    return (Z.createElement(ButtonStyled, { className: className, css: css, "data-testid": testId }, children));
};
...
export { Button, genKey, globalStyles, instance as i18n, rgba, stitches_config as stitches, tokens, useCopyToClipboard, useFocus, useFocusWithin, useHover, useLocalStorage, useLockedBody, useMediaQuery, usePress, usePressWithin, useTargetBoundary, useTranslation, useUniqueId, useWindowSize };
